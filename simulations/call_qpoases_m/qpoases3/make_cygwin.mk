...
CPPFLAGS = -std=c99 -Wall -pedantic -Wshadow -Wfloat-equal -Wconversion -Wsign-conversion -O3 -finline-functions -DLINUX -D__NO_COPYRIGHT__ 
#CPPFLAGS = -std=c90 -Dinline="" -Wno-unused-function -Wall -pedantic -Wshadow -Wfloat-equal -Wconversion -Wsign-conversion -O3 -finline-functions -DLINUX -D__NO_COPYRIGHT__
