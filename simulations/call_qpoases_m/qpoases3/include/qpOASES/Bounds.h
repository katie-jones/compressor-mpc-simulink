 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INVALID_ARGUMENTS */
returnValue Bounds_setupBound(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INDEX_OUT_OF_BOUNDS */
returnValue Bounds_moveFixedToFree(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_MOVING_BOUND_FAILED \n
			RET_INDEX_OUT_OF_BOUNDS */
returnValue Bounds_moveFreeToFixed(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_MOVING_BOUND_FAILED \n
			RET_INDEX_OUT_OF_BOUNDS */
returnValue Bounds_flipFixed(	Bounds* THIS,
								int number
								);
...
returnValue Bounds_swapFree(	Bounds* THIS,
 ...
 *	\return Type of bound \n
 			RET_INDEX_OUT_OF_BOUNDS */
static inline SubjectToType Bounds_getType(	Bounds* THIS,
 ...
 *	\return Status of bound \n
 			ST_UNDEFINED */
static inline SubjectToStatus Bounds_getStatus(	Bounds* THIS,
												int i		/**< Number of bound. */
												);
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_INDEX_OUT_OF_BOUNDS */
static inline returnValue Bounds_setType(	Bounds* THIS,
											int i,				/**< Number of bound. */
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_INDEX_OUT_OF_BOUNDS */
static inline returnValue Bounds_setStatus(	Bounds* THIS,
											int i,					/**< Number of bound. */
...
static inline void Bounds_setNoLower(	Bounds* THIS,
										BooleanType _status		/**< Status of lower bounds. */
										);

/** Sets status of upper bounds. */
static inline void Bounds_setNoUpper(	Bounds* THIS,
...
static inline BooleanType Bounds_hasNoLower(	Bounds* THIS
												);

/** Returns status of upper bounds.
 *	\return BT_TRUE if there is no upper bound on any variable. */
static inline BooleanType Bounds_hasNoUpper(	Bounds* THIS
												);
 ...
 *	\return SUCCESSFUL_RETURN \n
 			...
 			RET_INVALID_ARGUMENTS \n
 			RET_SHIFTING_FAILED */
returnValue Bounds_shift(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_INDEX_OUT_OF_BOUNDS \n
 			RET_ROTATING_FAILED */
returnValue Bounds_rotate(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_SETUP_BOUND_FAILED */
returnValue Bounds_setupAll(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_ADDINDEX_FAILED \n
			RET_INVALID_ARGUMENTS */
returnValue Bounds_addIndex(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INVALID_ARGUMENTS */
returnValue Bounds_removeIndex(	Bounds* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_SWAPINDEX_FAILED \n
			RET_INVALID_ARGUMENTS */
returnValue Bounds_swapIndex(	Bounds* THIS,
 ...
 */
static inline int Bounds_getNumberOfType( Bounds* THIS, SubjectToType _type )
{
	int i;
	int numberOfType = 0;
 ...
 *	g e t T y p e
 */
static inline SubjectToType Bounds_getType( Bounds* THIS, int i )
{
	if ( ( i >= 0 ) && ( i < THIS->n ) )
		return THIS->type[i];
 ...
 *	g e t S t a t u s
 */
static inline SubjectToStatus Bounds_getStatus( Bounds* THIS, int i )
{
	if ( ( i >= 0 ) && ( i < THIS->n ) )
 ...
 *	s e t T y p e
 */
static inline returnValue Bounds_setType( Bounds* THIS, int i, SubjectToType value )
{
	if ( ( i >= 0 ) && ( i < THIS->n ) )
	{
		THIS->type[i] = value;
 ...
 *	s e t S t a t u s
 */
static inline returnValue Bounds_setStatus( Bounds* THIS, int i, SubjectToStatus value )
{
	if ( ( i >= 0 ) && ( i < THIS->n ) )
	{
		THIS->status[i] = value;
 ...
 *	s e t N o L o w e r
 */
static inline void Bounds_setNoLower( Bounds* THIS, BooleanType _status )
{
 ...
 *	s e t N o U p p e r
 */
static inline void Bounds_setNoUpper( Bounds* THIS, BooleanType _status )
{
...
static inline int Bounds_getNFV( Bounds* THIS )
{
 	return Bounds_getNumberOfType( THIS,ST_EQUALITY );
}
...
static inline int Bounds_getNBV( Bounds* THIS )
{
 	return Bounds_getNumberOfType( THIS,ST_BOUNDED );
}
...
static inline int Bounds_getNUV( Bounds* THIS )
{
	return Bounds_getNumberOfType( THIS,ST_UNBOUNDED );
}
...
static inline int Bounds_getNFR( Bounds* THIS )
{
 	return Indexlist_getLength( &(THIS->freee) );
}
...
static inline int Bounds_getNFX( Bounds* THIS )
{
	return Indexlist_getLength( &(THIS->fixed) );
}
