...
/**
 *	\file include/qpOASES/QProblem.h
...
#include <qpOASES/ConstraintProduct.h>
...
returnValue QProblem_initM(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblem_init(	QProblem* THIS,
...
returnValue QProblem_initF(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblem_initMW(	QProblem* THIS,
								DenseMatrix *_H, 							/**< Hessian matrix. */
								const real_t* const _g, 					/**< Gradient vector. */
								DenseMatrix *_A, 			 				/**< Constraint matrix. */
								const real_t* const _lb,					/**< Lower bound vector (on variables). \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblem_initW(	QProblem* THIS,
							real_t* const _H, 							/**< Hessian matrix. \n
														     				 If Hessian matrix is trivial, a NULL pointer can be passed. */
							const real_t* const _g, 					/**< Gradient vector. */
							real_t* const _A,  							/**< Constraint matrix. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_UNABLE_TO_READ_FILE */
returnValue QProblem_initFW(	QProblem* THIS,
								const char* const H_file,					/**< Name of file where Hessian matrix is stored. \n
														     					 If Hessian matrix is trivial, a NULL pointer can be passed. */
								const char* const g_file,					/**< Name of file where gradient vector is stored. */
								const char* const A_file,					/**< Name of file where constraint matrix is stored. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_UNABLE_TO_READ_FILE \n
			RET_INVALID_ARGUMENTS */
returnValue QProblem_hotstartF(	QProblem* THIS,
...
returnValue QProblem_hotstartW(	QProblem* THIS,
								const real_t* const g_new,					/**< Gradient of neighbouring QP to be solved. */
								const real_t* const lb_new,					/**< Lower bounds of neighbouring QP to be solved. \n
											 						 			 If no lower bounds exist, a NULL pointer can be passed. */
								const real_t* const ub_new,					/**< Upper bounds of neighbouring QP to be solved. \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_UNABLE_TO_READ_FILE \n
			RET_INVALID_ARGUMENTS */
returnValue QProblem_hotstartFW(	QProblem* THIS,
									const char* const g_file, 					/**< Name of file where gradient, of neighbouring QP to be solved, is stored. */
									const char* const lb_file, 					/**< Name of file where lower bounds, of neighbouring QP to be solved, is stored. \n
											 										 If no lower bounds exist, a NULL pointer can be passed. */
									const char* const ub_file, 					/**< Name of file where upper bounds, of neighbouring QP to be solved, is stored. \n
...
static inline returnValue QProblem_getConstraints(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_QP_NOT_SOLVED */
returnValue QProblem_getDualSolution(	QProblem* THIS,
 ...
 *	\return  SUCCESSFUL_RETURN \n */
returnValue QProblem_setConstraintProduct(	QProblem* THIS,
...
*	\return SUCCESSFUL_RETURN */
returnValue QProblem_getWorkingSet(	QProblem* THIS,
...
/** Returns current bounds object of the QP (deep copy).
  *	\return SUCCESSFUL_RETURN \n
  			RET_QPOBJECT_NOT_SETUP */
static inline returnValue QProblem_getBounds(	QProblem* THIS,
...
static inline int QProblem_getNV( QProblem* THIS );

/** Returns the number of free variables.
 *	\return Number of free variables. */
static inline int QProblem_getNFR( QProblem* THIS );

/** Returns the number of fixed variables.
 *	\return Number of fixed variables. */
static inline int QProblem_getNFX( QProblem* THIS );

/** Returns the number of implicitly fixed variables.
 *	\return Number of implicitly fixed variables. */
static inline int QProblem_getNFV( QProblem* THIS );
...
real_t QProblem_getObjValX(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_QP_NOT_SOLVED */
returnValue QProblem_getPrimalSolution(	QProblem* THIS,
...
static inline BooleanType QProblem_usingRegularisation( QProblem* THIS );

/** Returns current options struct.
 *	\return Current options struct. */
static inline Options QProblem_getOptions( QProblem* THIS );

/** Overrides current options with given ones.
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblem_setOptions(	QProblem* THIS,
												Options _options	/**< New options. */
												);

/** Returns the print level.
 *	\return Print level. */
static inline PrintLevel QProblem_getPrintLevel( QProblem* THIS );

/** Changes the print level.
 *	\return SUCCESSFUL_RETURN */
returnValue QProblem_setPrintLevel(	QProblem* THIS,
 ...
 *	\return	 RET_LINEARLY_DEPENDENT \n
			 ...
			 RET_INDEXLIST_CORRUPTED */
returnValue QProblem_addConstraint_checkLI(	QProblem* THIS,
											int number			/**< Number of constraint to be added to active set. */
											);
...
returnValue QProblem_addConstraint_ensureLI(	QProblem* THIS,
												int number,					/**< Number of constraint to be added to active set. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_ENSURELI_FAILED */
returnValue QProblem_addBound(	QProblem* THIS,
 ...
 *	\return	 RET_LINEARLY_DEPENDENT \n
 			 RET_LINEARLY_INDEPENDENT */
returnValue QProblem_addBound_checkLI(	QProblem* THIS,
										int number			/**< Number of bound to be added to active set. */
										);
 ...
 *	\return	 SUCCESSFUL_RETURN \n
			 ...
			 RET_ENSURELI_FAILED_NOINDEX \n
			 RET_REMOVE_FROM_ACTIVESET */
returnValue QProblem_addBound_ensureLI(	QProblem* THIS,
										int number,					/**< Number of bound to be added to active set. */
										SubjectToStatus B_status	/**< Status of new active bound. */
										);
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_HESSIAN_NOT_SPD */
returnValue QProblem_removeConstraint(	QProblem* THIS,
...
returnValue QProblem_removeBound(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_DIV_BY_ZERO */
returnValue QProblem_backsolveT(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN */
returnValue QProblem_determineDataShift(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 			RET_STEPDIRECTION_FAILED_TQ \n
			RET_STEPDIRECTION_FAILED_CHOLESKY */
returnValue QProblem_determineStepDirection(	QProblem* THIS,
 ...
 * 			RET_QP_INFEASIBLE */
returnValue QProblem_performStep(	QProblem* THIS,
 ...
 *			RET_SETUP_AUXILIARYQP_FAILED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblem_setupAuxiliaryQP(	QProblem* THIS,
										Bounds* const guessedBounds,			/**< Initial guess for working set of bounds. */
										Constraints* const guessedConstraints	/**< Initial guess for working set of constraints. */
										);
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setAM(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setA(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setLBA(	QProblem* THIS,
...
static inline returnValue QProblem_setLBAn(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setUBA(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN  \n
			RET_INDEX_OUT_OF_BOUNDS */
static inline returnValue QProblem_setUBAn(	QProblem* THIS,
											int number,		/**< Number of entry to be changed. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_OBTAINING_WORKINGSET_FAILED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemBCPY_obtainAuxiliaryWorkingSet(	QProblem* THIS,
													const real_t* const xOpt,			/**< Optimal primal solution vector.
																						*	 If a NULL pointer is passed, all entries are assumed to be zero. */
													const real_t* const yOpt,			/**< Optimal dual solution vector.
																						*	 If a NULL pointer is passed, all entries are assumed to be zero. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_DIV_BY_ZERO */
returnValue QProblem_backsolveR(	QProblem* THIS,
									const real_t* const b,	/**< Right hand side vector. */
									BooleanType transposed,	/**< Indicates if the transposed system shall be solved. */
									real_t* const a 		/**< Output: Solution vector */
									);
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_DIV_BY_ZERO */
returnValue QProblem_backsolveRrem(	QProblem* THIS,
									const real_t* const b,		/**< Right hand side vector. */
									BooleanType transposed,		/**< Indicates if the transposed system shall be solved. */
...
/** Determines step direction of the shift of the QP data.
 *	\return SUCCESSFUL_RETURN */
returnValue QProblemBCPY_determineDataShift(	QProblem* THIS,
												const real_t* const g_new,	/**< New gradient vector. */
												const real_t* const lb_new,	/**< New lower bounds. */
												const real_t* const ub_new,	/**< New upper bounds. */
												real_t* const delta_g,	 	/**< Output: Step direction of gradient vector. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemBCPY_setupQPdataM(	QProblem* THIS,
										DenseMatrix *_H,	 	/**< Hessian matrix.*/
										const real_t* const _g,		/**< Gradient vector. */
...
returnValue QProblemBCPY_setupQPdata(	QProblem* THIS,
										real_t* const _H, 	/**< Hessian matrix. \n
																		If Hessian matrix is trivial,a NULL pointer can be passed. */
										const real_t* const _g,		/**< Gradient vector. */
										const real_t* const _lb,	/**< Lower bounds (on variables). \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INVALID_ARGUMENTS \n
			RET_NO_HESSIAN_SPECIFIED */
returnValue QProblemBCPY_setupQPdataFromFile(	QProblem* THIS,
												const char* const H_file, 	/**< Name of file where Hessian matrix, of neighbouring QP to be solved, is stored. \n
														     					 If Hessian matrix is trivial,a NULL pointer can be passed. */
												const char* const g_file, 	/**< Name of file where gradient, of neighbouring QP to be solved, is stored. */
												const char* const lb_file, 	/**< Name of file where lower bounds, of neighbouring QP to be solved, is stored. \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_UNABLE_TO_READ_FILE \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemBCPY_loadQPvectorsFromFile(	QProblem* THIS,
												const char* const g_file, 	/**< Name of file where gradient, of neighbouring QP to be solved, is stored. */
												const char* const lb_file, 	/**< Name of file where lower bounds, of neighbouring QP to be solved, is stored. \n
										 			 							 If no lower bounds exist, a NULL pointer can be passed. */
												const char* const ub_file, 	/**< Name of file where upper bounds, of neighbouring QP to be solved, is stored. \n
...
BooleanType QProblem_isCPUtimeLimitExceeded(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblem_setHM(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblem_setH(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setG(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setLB(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN  \n
			RET_INDEX_OUT_OF_BOUNDS */
static inline returnValue QProblem_setLBn(	QProblem* THIS,
											int number,		/**< Number of entry to be changed. */
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblem_setUB(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN  \n
			RET_INDEX_OUT_OF_BOUNDS */
static inline returnValue QProblem_setUBn(	QProblem* THIS,
											int number,		/**< Number of entry to be changed. */
 ...
 *	\return  SUCCESSFUL_RETURN */
static inline BooleanType QProblem_isBlocking(	QProblem* THIS,
 ...
 *	\return SUCCESSFUL_RETURN  \n
			RET_UNABLE_TO_OPEN_FILE */
returnValue QProblem_writeQpDataIntoMatFile(	QProblem* THIS,
...
*	\return SUCCESSFUL_RETURN  \n
			RET_UNABLE_TO_OPEN_FILE */
returnValue QProblem_writeQpWorkspaceIntoMatFile(	QProblem* THIS,
													const char* const filename	/**< Mat file name. */
													);
 ...
 *	g e t B o u n d s
 */
static inline returnValue QProblem_getBounds( QProblem* THIS, Bounds* _bounds )
{
...
static inline int QProblem_getNV( QProblem* THIS )
{
	return Bounds_getNV( &(THIS->bounds) );
}
...
static inline int QProblem_getNFR( QProblem* THIS )
{
	return Bounds_getNFR( &(THIS->bounds) );
}
...
static inline int QProblem_getNFX( QProblem* THIS )
{
	return Bounds_getNFX( &(THIS->bounds) );
}
...
static inline int QProblem_getNFV( QProblem* THIS )
{
	return Bounds_getNFV( &(THIS->bounds) );
}
...
static inline BooleanType QProblem_isInitialised( QProblem* THIS )
{
	if ( THIS->status == QPS_NOTINITIALISED )
		return BT_FALSE;
	else
		return BT_TRUE;
}
 ...
 */
static inline returnValue QProblem_setHessianType( QProblem* THIS, HessianType _hessianType )
{
...
{
	OptionsCPY( &_options,&(THIS->options) );
	Options_ensureConsistency( &(THIS->options) );
...
static inline PrintLevel QProblem_getPrintLevel( QProblem* THIS )
{
	return THIS->options.printLevel;
}
 ...
 *	s e t H
 */
static inline returnValue QProblem_setHM( QProblem* THIS, DenseMatrix* H_new )
{
	if ( H_new == 0 )
		return QProblem_setH( THIS,(real_t*)0 );
	else
		return QProblem_setH( THIS,DenseMatrix_getVal(H_new) );
}
 ...
 *	s e t H
 */
static inline returnValue QProblem_setH( QProblem* THIS, real_t* const H_new )
{
	...
	{
		DenseMatrix_init( THIS->H,QProblem_getNV( THIS ),QProblem_getNV( THIS ),QProblem_getNV( THIS ),H_new );
	}
 ...
 *	s e t G
 */
static inline returnValue QProblem_setG( QProblem* THIS, const real_t* const g_new )
{
	unsigned int nV = (unsigned int)QProblem_getNV( THIS );
	...
	memcpy( THIS->g,g_new,nV*sizeof(real_t) );
 ...
 *	s e t L B
 */
static inline returnValue QProblem_setLB( QProblem* THIS, const real_t* const lb_new )
{
	unsigned int nV = (unsigned int)QProblem_getNV( THIS );
	...
	memcpy( THIS->lb,lb_new,nV*sizeof(real_t) );
 ...
 *	s e t L B
 */
static inline returnValue QProblem_setLBn( QProblem* THIS, int number, real_t value )
{
	int nV = QProblem_getNV( THIS );
 ...
 *	s e t U B
 */
static inline returnValue QProblem_setUB( QProblem* THIS, const real_t* const ub_new )
{
	unsigned int nV = (unsigned int)QProblem_getNV( THIS );
	...
	memcpy( THIS->ub,ub_new,nV*sizeof(real_t) );
 ...
 *	s e t U B
 */
static inline returnValue QProblem_setUBn( QProblem* THIS, int number, real_t value )
{
	int nV = QProblem_getNV( THIS );
 ...
 */
static inline returnValue QProblem_getConstraints( QProblem* THIS, Constraints* _constraints )
{
	int nV = QProblem_getNV( THIS );
	...
	ConstraintsCPY( &(THIS->constraints),_constraints );
...
static inline int QProblem_getNC( QProblem* THIS )
{
	return Constraints_getNC( &(THIS->constraints) );
}
...
static inline int QProblem_getNEC( QProblem* THIS )
{
	return Constraints_getNEC( &(THIS->constraints) );
}
...
static inline int QProblem_getNAC( QProblem* THIS )
{
	return Constraints_getNAC( &(THIS->constraints) );
}
...
static inline int QProblem_getNIAC( QProblem* THIS )
{
	return Constraints_getNIAC( &(THIS->constraints) );
}
 ...
 *	s e t A
 */
static inline returnValue QProblem_setAM( QProblem* THIS, DenseMatrix *A_new )
{
	if ( A_new == 0 )
		return QProblem_setA( THIS,(real_t*)0 );
	else
		return QProblem_setA( THIS,DenseMatrix_getVal(A_new) );
}
 ...
 *	s e t A
 */
static inline returnValue QProblem_setA( QProblem* THIS, real_t* const A_new )
{
	int j;
	int nV = QProblem_getNV( THIS );
	...
	DenseMatrix_init( THIS->A,QProblem_getNC( THIS ),QProblem_getNV( THIS ),QProblem_getNV( THIS ),A_new );

	DenseMatrix_times( THIS->A,1, 1.0, THIS->x, nV, 0.0, THIS->Ax, nC);

	for( j=0; j<nC; ++j )
	{
		THIS->Ax_u[j] = THIS->ubA[j] - THIS->Ax[j];
		THIS->Ax_l[j] = THIS->Ax[j] - THIS->lbA[j];
	}
 ...
 *	s e t L B A
 */
static inline returnValue QProblem_setLBA( QProblem* THIS, const real_t* const lbA_new )
{
	int i;
	int nV = QProblem_getNV( THIS );
	int nC = QProblem_getNC( THIS );
 ...
 *	s e t L B A
 */
static inline returnValue QProblem_setLBAn( QProblem* THIS, int number, real_t value )
{
	int nV = QProblem_getNV( THIS );
	int nC = QProblem_getNC( THIS );
 ...
 *	s e t U B A
 */
static inline returnValue QProblem_setUBA( QProblem* THIS, const real_t* const ubA_new )
{
	int i;
	int nV = QProblem_getNV( THIS );
	int nC = QProblem_getNC( THIS );
 ...
 *	s e t U B A
 */
static inline returnValue QProblem_setUBAn( QProblem* THIS, int number, real_t value )
{
	int nV = QProblem_getNV( THIS );
	int nC = QProblem_getNC( THIS );
