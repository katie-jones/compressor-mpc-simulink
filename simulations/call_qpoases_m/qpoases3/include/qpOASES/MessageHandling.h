...
/**
 *	\file include/qpOASES/MessageHandling.h
...
void MessageHandlingCON(	MessageHandling* THIS,
 ...
 */
returnValue MessageHandling_throwError(	MessageHandling* THIS,
 ...
 */
returnValue MessageHandling_throwWarning(	MessageHandling* THIS,
 ...
 */
returnValue MessageHandling_throwInfo(	MessageHandling* THIS,
...
returnValue MessageHandling_reset( MessageHandling* THIS );


/** Prints a complete list of all messages to output file.
 *	\return SUCCESSFUL_RETURN */
returnValue MessageHandling_listAllMessages( MessageHandling* THIS );


/** Returns visibility status for error messages.
 *	\return Visibility status for error messages. */
static inline VisibilityStatus MessageHandling_getErrorVisibilityStatus( MessageHandling* THIS );

/** Returns visibility status for warning messages.
 *	\return Visibility status for warning messages. */
static inline VisibilityStatus MessageHandling_getWarningVisibilityStatus( MessageHandling* THIS );

/** Returns visibility status for info messages.
 *	\return Visibility status for info messages. */
static inline VisibilityStatus MessageHandling_getInfoVisibilityStatus( MessageHandling* THIS );

/** Returns pointer to output file.
 *	\return Pointer to output file. */
static inline FILE* MessageHandling_getOutputFile( MessageHandling* THIS );

/** Returns error count value.
 *	\return Error count value. */
static inline int MessageHandling_getErrorCount( MessageHandling* THIS );


/** Changes visibility status for error messages. */
static inline void MessageHandling_setErrorVisibilityStatus(	MessageHandling* THIS,
														VisibilityStatus _errorVisibility	/**< New visibility status for error messages. */
														);

/** Changes visibility status for warning messages. */
static inline void MessageHandling_setWarningVisibilityStatus(	MessageHandling* THIS,
...
static inline void MessageHandling_setInfoVisibilityStatus(	MessageHandling* THIS,
															VisibilityStatus _infoVisibility	/**< New visibility status for info messages. */
															);

/** Changes output file for messages. */
static inline void MessageHandling_setOutputFile(	MessageHandling* THIS,
...
static inline returnValue MessageHandling_setErrorCount(	MessageHandling* THIS,
...
const char* MessageHandling_getErrorCodeMessage(	MessageHandling* THIS,
													const returnValue _returnValue
													);


returnValue MessageHandling_throwMessage(	MessageHandling* THIS,
 ...
 */
static inline void MessageHandling_setErrorVisibilityStatus( MessageHandling* THIS, VisibilityStatus _errorVisibility )
{
 	THIS->errorVisibility = _errorVisibility;
}
 ...
 */
static inline void MessageHandling_setWarningVisibilityStatus( MessageHandling* THIS, VisibilityStatus _warningVisibility )
{
 	THIS->warningVisibility = _warningVisibility;
}
 ...
 */
static inline void MessageHandling_setInfoVisibilityStatus( MessageHandling* THIS, VisibilityStatus _infoVisibility )
{
 	THIS->infoVisibility = _infoVisibility;
}
 ...
 */
static inline void MessageHandling_setOutputFile( MessageHandling* THIS, FILE* _outputFile )
{
 ...
 */
static inline returnValue MessageHandling_setErrorCount( MessageHandling* THIS, int _errorCount )
{
	if ( _errorCount >= 0 )
	{
		THIS->errorCount = _errorCount;
		return SUCCESSFUL_RETURN;
	}
	else
