...
/**
 *	\file include/qpOASES/QProblemB.h
...
returnValue QProblemB_initM(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_init(	QProblemB* THIS,
...
returnValue QProblemB_initF(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_initMW(	QProblemB* THIS,
								DenseMatrix *_H,				/**< Hessian matrix. */
								const real_t* const _g,				/**< Gradient vector. */
								const real_t* const _lb,			/**< Lower bounds (on variables). \n
																		 If no lower bounds exist, a NULL pointer can be passed. */
								...
								const real_t* const yOpt,			/**< Optimal dual solution vector.
																		 A NULL pointer can be passed. */
								Bounds* const guessedBounds	/**< Optimal working set for solution (xOpt,yOpt).
																		 A NULL pointer can be passed. */
								);
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_initW(	QProblemB* THIS,
								real_t* const _H, 					/**< Hessian matrix. \n
																		 If Hessian matrix is trivial, a NULL pointer can be passed. */
								const real_t* const _g,				/**< Gradient vector. */
								const real_t* const _lb,			/**< Lower bounds (on variables). \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_MAX_NWSR_REACHED \n
			RET_UNABLE_TO_READ_FILE */
returnValue QProblemB_initFW(	QProblemB* THIS,
								const char* const H_file, 			/**< Name of file where Hessian matrix is stored. \n
																		 If Hessian matrix is trivial, a NULL pointer can be passed. */
								const char* const g_file,  			/**< Name of file where gradient vector is stored. */
								const char* const lb_file, 			/**< Name of file where lower bound vector. \n
...
returnValue QProblemB_hotstart(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_UNABLE_TO_READ_FILE \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_hotstartF(	QProblemB* THIS,
...
returnValue QProblemB_hotstartW(	QProblemB* THIS,
									const real_t* const g_new,			/**< Gradient of neighbouring QP to be solved. */
									const real_t* const lb_new,			/**< Lower bounds of neighbouring QP to be solved. \n
											 								 If no lower bounds exist, a NULL pointer can be passed. */
									const real_t* const ub_new,			/**< Upper bounds of neighbouring QP to be solved. \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INVALID_ARGUMENTS \n
			RET_SETUP_AUXILIARYQP_FAILED */
returnValue QProblemB_hotstartFW(	QProblemB* THIS,
									const char* const g_file,			/**< Name of file where gradient, of neighbouring QP to be solved, is stored. */
									const char* const lb_file,			/**< Name of file where lower bounds, of neighbouring QP to be solved, is stored. \n
											 								 If no lower bounds exist, a NULL pointer can be passed. */
									const char* const ub_file, 			/**< Name of file where upper bounds, of neighbouring QP to be solved, is stored. \n
...
*	\return SUCCESSFUL_RETURN */
returnValue QProblemB_getWorkingSet(	QProblemB* THIS,
...
static inline returnValue QProblemB_getBounds(	QProblemB* THIS,
...
static inline int QProblemB_getNV( QProblemB* THIS );

/** Returns the number of free variables.
 *	\return Number of free variables. */
static inline int QProblemB_getNFR( QProblemB* THIS );

/** Returns the number of fixed variables.
 *	\return Number of fixed variables. */
static inline int QProblemB_getNFX( QProblemB* THIS );

/** Returns the number of implicitly fixed variables.
 *	\return Number of implicitly fixed variables. */
static inline int QProblemB_getNFV( QProblemB* THIS );
...
real_t QProblemB_getObjValX(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_QP_NOT_SOLVED */
returnValue QProblemB_getPrimalSolution(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_QP_NOT_SOLVED */
returnValue QProblemB_getDualSolution(	QProblemB* THIS,
...
static inline BooleanType QProblemB_usingRegularisation( QProblemB* THIS );

/** Returns current options struct.
 *	\return Current options struct. */
static inline Options QProblemB_getOptions( QProblemB* THIS );

/** Overrides current options with given ones.
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblemB_setOptions(	QProblemB* THIS,
												Options _options	/**< New options. */
												);

/** Returns the print level.
 *	\return Print level. */
static inline PrintLevel QProblemB_getPrintLevel( QProblemB* THIS );

/** Changes the print level.
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblemB_setPrintLevel(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_SETUPSUBJECTTOTYPE_FAILED */
returnValue QProblemB_setupSubjectToTypeNew(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_obtainAuxiliaryWorkingSet(	QProblemB* THIS,
													const real_t* const xOpt,		/**< Optimal primal solution vector.
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_DIV_BY_ZERO */
returnValue QProblemB_backsolveR(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_DIV_BY_ZERO */
returnValue QProblemB_backsolveRrem(	QProblemB* THIS,
										const real_t* const b,		/**< Right hand side vector. */
										BooleanType transposed,		/**< Indicates if the transposed system shall be solved. */
 ...
 *	\return SUCCESSFUL_RETURN */
returnValue QProblemB_determineDataShift(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_setupQPdataM(	QProblemB* THIS,
									DenseMatrix *_H,	 	/**< Hessian matrix.*/
									const real_t* const _g,		/**< Gradient vector. */
									const real_t* const _lb,	/**< Lower bounds (on variables). \n
																	If no lower bounds exist, a NULL pointer can be passed. */
...
returnValue QProblemB_setupQPdata(	QProblemB* THIS,
									real_t* const _H, 	/**< Hessian matrix. \n
																	 If Hessian matrix is trivial,a NULL pointer can be passed. */
									const real_t* const _g,		/**< Gradient vector. */
									const real_t* const _lb,	/**< Lower bounds (on variables). \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INVALID_ARGUMENTS \n
			RET_NO_HESSIAN_SPECIFIED */
returnValue QProblemB_setupQPdataFromFile(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_UNABLE_TO_READ_FILE \n
			RET_INVALID_ARGUMENTS */
returnValue QProblemB_loadQPvectorsFromFile(	QProblemB* THIS,
												const char* const g_file, 	/**< Name of file where gradient, of neighbouring QP to be solved, is stored. */
												const char* const lb_file, 	/**< Name of file where lower bounds, of neighbouring QP to be solved, is stored. \n
										 			 							 If no lower bounds exist, a NULL pointer can be passed. */
												const char* const ub_file, 	/**< Name of file where upper bounds, of neighbouring QP to be solved, is stored. \n
...
BooleanType QProblemB_isCPUtimeLimitExceeded(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblemB_setHM(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN */
static inline returnValue QProblemB_setH(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblemB_setG(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblemB_setLB(	QProblemB* THIS,
...
static inline returnValue QProblemB_setLBn(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_INVALID_ARGUMENTS */
static inline returnValue QProblemB_setUB(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN  \n
			RET_INDEX_OUT_OF_BOUNDS */
static inline returnValue QProblemB_setUBn(	QProblemB* THIS,
											int number,		/**< Number of entry to be changed. */
 ...
 *	\return  SUCCESSFUL_RETURN */
static inline BooleanType QProblemB_isBlocking(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_INIT_FAILED_UNBOUNDEDNESS \n
			RET_MAX_NWSR_REACHED */
returnValue QProblemB_solveInitialQP(	QProblemB* THIS,
										const real_t* const xOpt,			/**< Optimal primal solution vector.
																			 *	 A NULL pointer can be passed. */
										const real_t* const yOpt,			/**< Optimal dual solution vector.
																			 *	 A NULL pointer can be passed. */
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_HOTSTART_STOPPED_INFEASIBILITY \n
			RET_HOTSTART_STOPPED_UNBOUNDEDNESS */
returnValue QProblemB_solveQP(	QProblemB* THIS,
								const real_t* const g_new,	/**< Gradient of neighbouring QP to be solved. */
								const real_t* const lb_new,	/**< Lower bounds of neighbouring QP to be solved. \n
											 					 If no lower bounds exist, a NULL pointer can be passed. */
								const real_t* const ub_new,	/**< Upper bounds of neighbouring QP to be solved. \n
 ...
 *	\return SUCCESSFUL_RETURN \n
			...
			RET_HOTSTART_STOPPED_INFEASIBILITY \n
			RET_HOTSTART_STOPPED_UNBOUNDEDNESS */
returnValue QProblemB_solveRegularisedQP(	QProblemB* THIS,
											const real_t* const g_new,	/**< Gradient of neighbouring QP to be solved. */
											const real_t* const lb_new,	/**< Lower bounds of neighbouring QP to be solved. \n
													 						 If no lower bounds exist, a NULL pointer can be passed. */
											const real_t* const ub_new,	/**< Upper bounds of neighbouring QP to be solved. \n
 ...
 *	\return SUCCESSFUL_RETURN */
returnValue QProblemB_setupAuxiliaryQPsolution(	QProblemB* THIS,
												const real_t* const xOpt,			/**< Optimal primal solution vector.
 ...
 *	\return SUCCESSFUL_RETURN \n
			RET_UNKNOWN_BUG */
returnValue QProblemB_setupAuxiliaryQPbounds(	QProblemB* THIS,
 ...
 *	\return SUCCESSFUL_RETURN \n
 *			RET_SETUP_AUXILIARYQP_FAILED */
returnValue QProblemB_setupAuxiliaryQP(	QProblemB* THIS,
										Bounds* const guessedBounds	/**< Initial guess for working set of bounds. */
										);
...
returnValue QProblemB_changeActiveSet(	QProblemB* THIS,
 ...
 */
BooleanType QProblemB_shallRefactorise(	QProblemB* THIS,
 ...
 *	g e t B o u n d s
 */
static inline returnValue QProblemB_getBounds( QProblemB* THIS, Bounds* _bounds )
{
 ...
 */
static inline returnValue QProblemB_setHessianType( QProblemB* THIS, HessianType _hessianType )
{
 ...
 */
static inline returnValue QProblemB_setPrintLevel( QProblemB* THIS, PrintLevel _printLevel )
{
 ...
 *	s e t H
 */
static inline returnValue QProblemB_setHM( QProblemB* THIS, DenseMatrix* H_new )
{
	if ( H_new == 0 )
		return QProblemB_setH( THIS,(real_t*)0 );
	else
		return QProblemB_setH( THIS,DenseMatrix_getVal(H_new) );
}
 ...
 *	s e t H
 */
static inline returnValue QProblemB_setH( QProblemB* THIS, real_t* const H_new )
{
	...
	{
		DenseMatrix_init( THIS->H,QProblemB_getNV( THIS ),QProblemB_getNV( THIS ),QProblemB_getNV( THIS ),H_new );
	}
 ...
 *	s e t G
 */
static inline returnValue QProblemB_setG( QProblemB* THIS, const real_t* const g_new )
{
	unsigned int nV = (unsigned int)QProblemB_getNV( THIS );
 ...
 *	s e t L B
 */
static inline returnValue QProblemB_setLB( QProblemB* THIS, const real_t* const lb_new )
{
	unsigned int nV = (unsigned int)QProblemB_getNV( THIS );
 ...
 *	s e t L B
 */
static inline returnValue QProblemB_setLBn( QProblemB* THIS, int number, real_t value )
{
	int nV = QProblemB_getNV( THIS );
 ...
 *	s e t U B
 */
static inline returnValue QProblemB_setUB( QProblemB* THIS, const real_t* const ub_new )
{
	unsigned int nV = (unsigned int)QProblemB_getNV( THIS );
 ...
 *	s e t U B
 */
static inline returnValue QProblemB_setUBn( QProblemB* THIS, int number, real_t value )
{
	int nV = QProblemB_getNV( THIS );
