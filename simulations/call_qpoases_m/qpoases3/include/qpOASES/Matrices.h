...
/**
 *	\file include/qpOASES/Matrices.h
 ...
 */
real_t DenseMatrix_getNorm( DenseMatrix* THIS,
 ...
 */
real_t DenseMatrix_getRowNorm(	DenseMatrix* THIS,
								int rNum,			/**< Row number. */
								int type			/**< Norm type, 1: one-norm, 2: Euclidean norm. */
								);
...
returnValue DenseMatrix_getRow(	DenseMatrix* THIS,
								int rNum,						/**< Row number. */
 ...
 *  \return SUCCESSFUL_RETURN */
 returnValue DenseMatrix_getCol(	DenseMatrix* THIS,
...
returnValue DenseMatrix_addToDiag(	DenseMatrix* THIS,
...
static inline real_t* DenseMatrix_getVal( DenseMatrix* THIS ) { return THIS->val; }
