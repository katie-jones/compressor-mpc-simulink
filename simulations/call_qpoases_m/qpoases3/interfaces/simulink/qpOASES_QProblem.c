...
/**
 *	\file interfaces/simulink/qpOASES_QProblem.c
...
static void mdlStart(SimStruct *S)
{
	...
	if ( size_H != nV*nV )
	{
		#ifndef __DSPACE__
		#ifndef __XPCTARGET__
        mexErrMsgTxt( "ERROR (qpOASES): Dimension mismatch (H)!" );
		#endif
		#endif
		return;
	}
	...
	if ( size_lb != nV )
	{
		#ifndef __DSPACE__
		#ifndef __XPCTARGET__
		mexErrMsgTxt( "ERROR (qpOASES): Dimension mismatch (lb)!" );
		#endif
		#endif
		return;
	}
	...
	if ( size_ub != nV )
	{
		#ifndef __DSPACE__
		#ifndef __XPCTARGET__
		mexErrMsgTxt( "ERROR (qpOASES): Dimension mismatch (ub)!" );
		#endif
		#endif
		return;
	}
	...
	if ( size_lbA != nC )
	{
		#ifndef __DSPACE__
		#ifndef __XPCTARGET__
		mexErrMsgTxt( "ERROR (qpOASES): Dimension mismatch (lbA)!" );
		#endif
		#endif
		return;
	}
	...
	if ( size_ubA != nC )
	{
		#ifndef __DSPACE__
		#ifndef __XPCTARGET__
		mexErrMsgTxt( "ERROR (qpOASES): Dimension mismatch (ubA)!" );
		#endif
		#endif
		return;
	}
	...
	QProblemCON( &problem,nV,nC,HST_UNKNOWN );
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    sprintf( fileName,"qpData%09d.mat",(int)(count[0]) );
