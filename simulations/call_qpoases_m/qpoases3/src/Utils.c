...
returnValue qpOASES_printCopyrightNotice( )
{
		...
		qpOASES_myPrintf( "\nqpOASESembedded -- An Embedded Implementation of the Online Active Set Strategy.\nCopyright (C) 2007-2014 by Hans Joachim Ferreau, Andreas Potschka,\nChristian Kirches et al. All rights reserved.\n\nqpOASES is distributed under the terms of the \nGNU Lesser General Public License 2.1 in the hope that it will be \nuseful, but WITHOUT ANY WARRANTY; without even the implied warranty \nof MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. \nSee the GNU Lesser General Public License for more details.\n\n" );
 ...
 */
void qpOASES_getKKTResidual(	int nV, int nC,
								...
								real_t* _stat, real_t* feas, real_t* cmpl
								)
{
...
/*
 *	g e t K K T R e s i d u a l S B
 */
void qpOASES_getKKTResidualSB(	int nV,
								const real_t* const H, const real_t* const g,
