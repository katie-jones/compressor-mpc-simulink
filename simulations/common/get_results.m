filename = '../../../cpp/build/cent_output.dat';
fname_info = '../../../cpp/build/cent_info.dat';
res_cent = read_cpp_results(filename,fname_info,11,4,4);

n_solver_iterations = 3;

filename = ['../../../cpp/build/coop_output',num2str(n_solver_iterations),'.dat'];
fname_info = ['../../../cpp/build/coop_info',num2str(n_solver_iterations),'.dat'];
res_coop = read_cpp_results(filename,fname_info,11,4,4);

filename = ['../../../cpp/build/noncoop_output',num2str(n_solver_iterations),'.dat'];
fname_info = ['../../../cpp/build/noncoop_info',num2str(n_solver_iterations),'.dat'];
