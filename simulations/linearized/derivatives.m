...
%% dp2dot/dp2
dx2x2 = SpeedSound * SpeedSound / VolumeT1 * 1e-5 * (-1/2*sign(p2-Out_pres)*100/sqrt(abs(p2*100-Out_pres*100))) * (D2(1)*Outflow_opening^3 + D2(2)*Outflow_opening^2 + D2(3)*Outflow_opening + D2(4));
