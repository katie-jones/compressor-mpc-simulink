...
if ( ispc == 0 )
	...
	CPPFLAGS  = [ IFLAGS, '-largeArrayDims -D__cpluplus -D__MATLAB__ -O -DWIN32 -D__NO_COPYRIGHT__', ' ' ]; %% -D__NO_COPYRIGHT__ -D__SUPPRESSANYOUTPUT__
end
...
for i = 1:3
    disp( [ 'Compiling ', NAME{i}, '.', eval('mexext'), '...'] );
