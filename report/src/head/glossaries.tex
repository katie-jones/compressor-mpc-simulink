...
\newglossaryentry{sd}
{
  name={\ensuremath{\mathit{SD}}},
  user1={\ensuremath{\mathit{SD}_1}},
  user2={\ensuremath{\mathit{SD}_2}},
  sort={SD},
  description={Surge distance},
  type={latin}
}
\newglossaryentry{scd}
{
  name={\ensuremath{\mathit{SCD}}},
  user1={\ensuremath{\mathit{SCD}_1}},
  user2={\ensuremath{\mathit{SCD}_2}},
  sort={SCD},
  description={Surge control distance},
  type={latin}
}
% \addlatnumbered{sd}{\ensuremath{SD\ut{XX}}}{Surge distance}
